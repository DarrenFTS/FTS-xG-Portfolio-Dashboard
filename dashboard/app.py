...
with col_title:
    st.markdown(
        ...
        '<span style="background:#16A34A;color:#fff;font-size:11px;font-weight:600;padding:2px 7px;border-radius:4px">4 LIVE</span> &nbsp;<span style="background:#D97706;color:#fff;font-size:11px;font-weight:600;padding:2px 7px;border-radius:4px">1 TEST</span> &nbsp;\u00b7 3,790 bets \u00b7 +20.65% ROI \u00b7 5 systems \u00b7 40 leagues'
        '</div></div>',
        unsafe_allow_html=True
    )
...
c1.metric("Total Bets",    "3,790",        "2021–2026 | 5 systems")
c2.metric("Total P/L",     "+782.45 pts",  "+20.65% ROI")
